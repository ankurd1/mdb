...
### Linux
Download the zip from [here](https://github.com/downloads/legalosLOTR/mdb/MDB-0.8a-linux2.zip)
...
### Windows
Download the zip from [here](https://github.com/downloads/legalosLOTR/mdb/MDB-0.8a-win32-2.zip)
and extract it somewhere.
